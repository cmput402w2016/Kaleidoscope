...
public class AACStream extends AudioStream {
	...
	protected static final int BUFFER_SIZE = 1600;
	...
	protected void encodeWithMediaCodec() throws IOException {
		...
		int bufferSize = AudioRecord.getMinBufferSize(mQuality.samplingRate, AudioFormat.CHANNEL_IN_MONO, AudioFormat.ENCODING_PCM_16BIT) * 16;
		...
		final MediaCodecInputStream inputStream = new AudioMediaCodecInputStream(mMediaCodec, mProfile, mSamplingRateIndex, mChannel);
		...
		mThread = new Thread(new Runnable() {
			...
			public void run() {
				...
				long prevTs = System.nanoTime() / 1000;
					...
					while (!Thread.interrupted()) {
						...
						if (bufferIndex >= 0) {
							...
							if (len == AudioRecord.ERROR_INVALID_OPERATION || len == AudioRecord.ERROR_BAD_VALUE) {
								...
								// Log.d(TAG, "AACStreamEncoder  ts differ: " +
								// (presentationTimeUs - prevTs));
								prevTs = presentationTimeUs;
